...
function tellFortune(jobTitle, location, partnerName, numberOfChildrenrams) {
    console.log(`You will be a ${jobTitle} in ${location} marrid to ${partnerName} with ${numberOfChildrenrams} children` )
}